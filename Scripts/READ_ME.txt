...
ROADMAP:
1. finish SimpleSeasonDaily.py
2. write into a dedicated database, instead of a csv-file
3. collect more data -> odds, bookies, more stats of each game, formation & squad